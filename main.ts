...
sprites.onOverlap(SpriteKind.Helicopter, SpriteKind.Food, function (sprite, otherSprite) {
    game.splash("You passed level 1")
})
let copter: Sprite = null
game.splash("Duck crossing", "Tap A to play ")
game.splash("Objective cross the road", "and get the bread ")
...
taco.y = 20
taco.x = 130
let cloud_4 = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . 8 8 8 8 8 8 8 8 8 . . . . 
    . . . 8 8 8 8 8 8 8 8 8 8 . . . 
    ...
    . 8 8 8 8 8 8 8 8 8 8 8 8 8 8 8 
    . 8 8 8 8 8 8 8 8 8 8 8 8 8 8 8 
    . 3 a b b b 2 b b b b 2 8 8 8 8 
    . a a 3 3 3 2 3 3 3 3 3 2 8 8 8 
    . 2 2 2 2 2 2 f a a a f 2 8 d d 
    . a a a a a a f a a f a 2 2 3 d 
    . a a a a a a f f f a a a 2 2 2 
    . a f f f f a a a a f f f 2 2 2 
    . . f f f f f a a f f f f f 2 . 
    . . . f f f . . . . f f f f . . 
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.Cloud)
cloud_4.x = 120
